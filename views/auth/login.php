    ...
    <div class="bg-white p-8  w-96">
        ...
        <form  method="POST" action="login">
            <div class="mb-4 pb-2">
                ...
                <input type="email" id="email" placeholder="Enter email" class="w-full p-2 mt-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div class="mb-4 pb-2">
                <label for="password" class="block  text-black font-mono ">Password</label>
                <input type="password" id="password" placeholder="Enter Password" class="w-full p-2 mt-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
