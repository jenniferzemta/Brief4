    ...
    <div class="flex  font-mono">
            <!-- Sidebar -->
            <aside class="w-48 bg-gray-800 text-white min-h-screen p-4">
                    <div class="mt-4">
                        <ul class="ml-4 space-y-2">
                            <li><a href="dashboard.php" class="block  bg-[#3889F2] text-sm hover:text-blue-300"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
                    ...
                    <div class="mt-4">
                        ...
                        <ul class="ml-4 space-y-2">
                            <li><a href="logs.php" class="block text-sm hover:text-blue-300"><i class="fas fa-user-circle"></i> Logs</a></li>
                        </ul>
                    </div>
                    <div class="mt-4">
